...
![СhatGPT_website](/chatgpt_manual/images/СhatGPT_registration/СhatGPT_website.png)
...
![OpenAI_API_not_available](/chatgpt_manual/images/СhatGPT_registration/OpenAI_API_not_available.png)
...
![OpenAI_API_wrong_russian_number](/chatgpt_manual/images/СhatGPT_registration/OpenAI_API_wrong_russian_number.png)
...
3. зайти на сайт [ChatGPT](![image-20230225122239680](C:/Users/user/AppData/Roaming/Typora/typora-user-images/image-20230225122239680.png))
   ![СhatGPT_login](/chatgpt_manual/images/СhatGPT_registration/СhatGPT_login.png)
...
6. После регистрации на [sms-man.ru](https://sms-man.ru/) выбираем страну "США" и сервис "OpeanAI", покупаем. Перед этим не забудьте пополнить счет на сайте через Qiwi
   ![sms_man_USA_OpenAI](/chatgpt_manual/images/СhatGPT_registration/sms_man_USA_OpenAI.png)
...
7. Указываем этот номер телефон на сайте при регистрации, чуть позже на номер телефона придет смс, её можно увидеть на сайте
   ![sms_man_USA_OpenAI](/chatgpt_manual/images/СhatGPT_registration/sms_man_USA_OpenAI_SMS.png)
...
9. В качестве финального шага [адрес ChatGPT](https://chat.openai.com/chat) можно превратить в ярлык на рабочем столе. Для этого нажимаем на три точки в правом верхнем углу, выбираем Дополнительные инструменты - Создать ярлык
   ![СhatGPT_thumbnail_creation](/chatgpt_manual/images/СhatGPT_registration/СhatGPT_thumbnail_creation.png)
   Нажимаем на галочку "Открыть в отдельном окне". Нажимаем кнопку "Создать"

   ![image-20230225123616061](/chatgpt_manual/images/СhatGPT_registration/СhatGPT_thumbnail_creation_2.png)
...
10. Теперь через ярлык на рабочем столе можно получить доступ к ChatGPT как к отдельную приложению, а не вкладке в браузере
    ![СhatGPT_thumbnail](/chatgpt_manual/images/СhatGPT_registration/СhatGPT_thumbnail.png)
...
![СhatGPT_thumbnail](/chatgpt_manual/images/СhatGPT_registration/adguard_error.png)