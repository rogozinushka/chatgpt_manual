...
Код рабочий, на удивление. Хотя я бы дополнительно обработал случай `older_version('1.1.0.0', '1.1')`, считая две эти версии одинаковыми.

**Напиши тесты и документацию для функции**

На вход подали функцию сверху и просьбу написать тесты и документацию
...
Круто, получился валидный docstring для функции, к тому же тесты не упали с ошибкой. Это похвально.
