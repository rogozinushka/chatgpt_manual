...
На вход chatGPT получила рандомный отзыв на мобильный телефон
...
А может быть попробовать смотреть не только тональность, но и более сложную классификацию?

На вход chatGPT получила рандомную новость
...
chatGPT может в мультиклассовую классиифкацию.
